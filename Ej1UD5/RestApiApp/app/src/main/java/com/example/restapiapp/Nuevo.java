...
public class Nuevo extends AppCompatActivity {
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if(etFecha==null){
            etFecha=findViewById(R.id.et_nuevo_birthdate);
        }
    ...
    public void aceptar(View view) {
        ...
        EditText textApellidos = findViewById(R.id.et_nuevo_apellidos);
        EditText textDni = findViewById(R.id.et_nuevo_dni);
        EditText textUsername = findViewById(R.id.et_nuevo_username);
        EditText textPassword = findViewById(R.id.et_nuevo_password);
        //Conseguir valores
        ...
        if(continuar){
            ...
            if (isNetworkAvailable()) {
                String url = res.getString(R.string.main_url) + "nuevoUsuario";
                if(dfecha==null){
                    fecha="";
                }
                sendTask(url, username, password, dni, nombre, apellidos, fecha);
            } else {
